            ...
            <el-col :span="14" class="total-price-right" v-if="orderStatus > 1">
              <el-card class="total-price-content" header="付款列表">
                ...
                >
                  ...
                  <el-table-column label="付款证明" prop="paymentProveFileList" v-if="proxy.$auth.hasRoleOr('manager')">
                    <template #default="scope">
                      <el-upload
                  ...
                  <el-table-column label="操作" prop="orderSn" v-if="proxy.$auth.hasRoleOr('manager')">
                    <template #default="scope">
