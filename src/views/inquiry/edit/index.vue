        ...
        <el-scrollbar height="100%" view-style="padding:5px 20px 20px;">
          <div class="purchase-order-detail-header">
            <div class="desc">
              ...
              <span>
                ...
                <el-button v-else v-hasRole="['purchase', 'purchaseAdmin']" type="primary" size="small"
          ...
          <el-row class="flex-center-right mt20" v-show="loading">
            ...
            <div class="right" v-show="form.ifEditable && !pageEdit">
              <el-button type="primary" v-hasRole="['purchase', 'purchaseAdmin']"
                v-show="!formDisabled && [1, 2].includes(inquiryStatus)" @click="submitForm(inquiryStatus)">
                暂存报价
              </el-button>
              <el-button type="primary" v-hasRole="['purchase', 'purchaseAdmin']"
                v-show="!formDisabled && [1, 2].includes(inquiryStatus)" @click="submitForm(3)">
                确认报价
              </el-button>
              <el-button type="success" v-show="!formDisabled &&
          ...
          <!-- 表单 -->
          <el-form ref="orderRef" :model="form" :rules="rules" label-width="80px" class="orderForm"
...
import { getInquiry, updateInquiry, editInquiryStatus, quotedHistory, editInquiryPurchaseUser, addDraft } from '@/api/inquiry'
